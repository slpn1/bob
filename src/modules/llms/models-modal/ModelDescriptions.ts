 ...
 * should be HTML-formatted text about the model's capabilities and use cases.
 * 
...
export const MODEL_DESCRIPTIONS: Record<string, string> = {
  ...
  'openai-chatgpt-4o-latest': `<h2>GPT-4o – <em>"The Generalist"</em></h2>
  <ul>
  ...
  'openai-gpt-4o-search-preview': `<p><strong>High-intelligence flagship model</strong> for complex, multi-step tasks.</p>
  ...
  'openai-o3': `<h2>OpenAI o3 – <em>“The Professor”</em></h2>
  <ul>
  ...
  'openai-o4-mini': `<h2>OpenAI o4 mini – <em>“The Problem Solver”</em></h2>
  <ul>
  ...
  'gpt-3.5-turbo': `<p><strong>Fast and cost-effective model</strong> for everyday use.</p>
    <p>Perfect for general conversations, basic writing, and simple tasks.</p>`,

  // Claude Models (with base patterns for better matching)
  'claude-3-5-sonnet': `<p><strong>Most intelligent Claude model</strong> with excellent coding abilities and nuanced understanding.</p>
  ...
  'claude-3-5-haiku': `<p><strong>Fast and efficient Claude model</strong> for quick tasks and real-time applications.</p>
  ...
  'claude-3-opus': `<p><strong>Most capable Claude model</strong> for complex reasoning and creative tasks.</p>
  ...
  'claude-3-sonnet': `<p><strong>Balanced model</strong> offering good performance for a wide range of tasks.</p>
  ...
  'claude-3-haiku': `<p><strong>Fastest Claude model</strong>, optimized for simple tasks and quick responses.</p>
...
export function getModelDescription(modelId: string): string {
  ...
  for (const [key, description] of Object.entries(MODEL_DESCRIPTIONS)) {
  ...
  // Default fallback
  return `<p><em>No description available for this model.</em></p>
