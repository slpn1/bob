...
export function ChatMessage(props: {
  ...
  const messageAvatarIcon = React.useMemo(
      ...
      [isUserMessageSkipped, isUserNotifyComplete, messageGeneratorName, messagePendingIncomplete, messagePurposeId, messageRole, showAvatarIcon, uiComplexityMode, fromUser],
  );
              ...
              <Box sx={zenMode ? messageZenAsideColumnSx : messageAsideColumnSx}>
                ...
                {fromAssistant && !zenMode && (
                    <TooltipOutlined asLargePane enableInteractive title={messageAvatarTooltip} placement='bottom-start'>
                      <Typography level='body-sm' sx={(messagePendingIncomplete && !Release.Features.LIGHTER_ANIMATIONS) ? messageAvatarLabelAnimatedSx : messageAvatarLabelSx}>
                        {messageAvatarLabel}
                      </Typography>
                    </TooltipOutlined>
                )}
